...
public class BubblePearlItem extends Item {
    public BubblePearlItem(Settings settings) {
        super(settings);
    }
    @Override
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.literal("A beautiful, iridescent pearl").formatted(Formatting.GRAY));
            tooltip.add(Text.literal("it seems to be hollow.").formatted(Formatting.GRAY));
        } else {
