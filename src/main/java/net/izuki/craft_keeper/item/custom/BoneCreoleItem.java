...
public class BoneCreoleItem extends Item {
    public BoneCreoleItem(Settings settings) {
        super(settings);
    }
    @Override
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.literal("A crude piece of jewelery").formatted(Formatting.GRAY));
            tooltip.add(Text.literal("carved from bone.").formatted(Formatting.GRAY));
        } else {
